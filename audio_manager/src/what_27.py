...
#     https://keras.io/api/applications/densenet/#densenet121-function
    model_name = "vgg16_lr0.0004_Dense-64" 

    model_run_name = "2020_10_02_" + model_name + "_1"  # Set image input to 32x32 
