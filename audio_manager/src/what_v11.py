...
#     train_examples, val_examples, train_labels, val_labels, number_of_distinct_labels, sound_to_integer_mapping = prepare_data_v4.get_data(create_data=create_data, testing=testing, display_image=display_image)
    train_examples, val_examples, train_labels, val_labels, number_of_distinct_labels, integer_to_sound_mapping = prepare_data_v4.get_data(create_data=create_data, testing=testing, display_image=display_image) 
