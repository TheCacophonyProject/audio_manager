...
#     keras_model_name = "NASNetLarge"           # Min image size is 32x32
    ...
    builtin_model_trainable = False # This refers to whether to keep Keras builtin model weights or train model from scratch - builtin_model_trainable = False means keep weights

    model_run_name = "2020_09_20_" + keras_model_name + "_v2"  
